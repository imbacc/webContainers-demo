...
async function runCommand(webcontainerInstance, spawn = { head: '', list: [] } error = '') {
  // Install dependencies
  const process = await webcontainerInstance.spawn(head, list)
  ...
  if (state !== 0) throw new Error(error)
